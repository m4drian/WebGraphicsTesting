...
export class BoundingBox {
     ...
     * @returns {boolean} True if there is an intersection.
     */
    intersectsRay(ray: import('./ray.js').Ray, point?: Vec3): boolean;
    /**
     ...
     */
    setFromTransformedAabb(aabb: BoundingBox, m: import('../math/mat4.js').Mat4, ignoreScale?: boolean): void;
    /**
     ...
     */
    intersectsBoundingSphere(sphere: import('./bounding-sphere.js').BoundingSphere): boolean;
