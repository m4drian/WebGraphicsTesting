export namespace random {
     ...
     * @ignore
     */
    function circlePoint(point: import("./vec2.js").Vec2): void;
    /**
     ...
     * @ignore
     */
    function circlePointDeterministic(point: import("./vec2.js").Vec2, index: number, numPoints: number): void;
    /**
     ...
     * @ignore
     */
    function spherePointDeterministic(point: import("./vec3.js").Vec3, index: number, numPoints: number, start?: number, end?: number): void;
    /**
