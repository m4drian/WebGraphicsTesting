...
export class Channel {
     ...
     */
    constructor(manager: import('../sound/manager.js').SoundManager, sound: import('../sound/sound.js').Sound, options?: {
        volume?: number;
        pitch?: number;
        loop?: boolean;
    });
    ...
    loop: boolean;
    pitch: number;
    sound: import("../sound/sound.js").Sound;
    paused: boolean;
    suspended: boolean;
    manager: import("../sound/manager.js").SoundManager;
