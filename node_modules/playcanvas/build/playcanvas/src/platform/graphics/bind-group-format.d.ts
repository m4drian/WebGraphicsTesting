...
export class BindGroupFormat {
     ...
     */
    constructor(graphicsDevice: import('./graphics-device.js').GraphicsDevice, formats: (BindTextureFormat | BindStorageTextureFormat | BindUniformBufferFormat | BindStorageBufferFormat)[]);
    /**
...
declare class BindBaseFormat {
     ...
     * @ignore
     */
    scopeId: import('./scope-id.js').ScopeId | null;
    /** @type {string} */
    name: string;
    visibility: number;
}
