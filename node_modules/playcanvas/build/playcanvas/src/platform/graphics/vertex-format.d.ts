...
export class VertexFormat {
     ...
     */
    static getDefaultInstancingFormat(graphicsDevice: import('./graphics-device.js').GraphicsDevice): VertexFormat;
     ...
     * ]);
     */
    constructor(graphicsDevice: import('./graphics-device.js').GraphicsDevice, description: {
        /**
