...
export class Shader {
     ...
     */
    constructor(graphicsDevice: import('./graphics-device.js').GraphicsDevice, definition: {
        name?: string;
        attributes?: {
            [x: string]: string;
        };
     ...
     * @ignore
     */
    meshUniformBufferFormat: import('./uniform-buffer-format.js').UniformBufferFormat;
    /**
     ...
     * @ignore
     */
    meshBindGroupFormat: import('./bind-group-format.js').BindGroupFormat;
    id: number;
