...
export class VertexBuffer {
     ...
     */
    constructor(graphicsDevice: import('./graphics-device.js').GraphicsDevice, format: import('./vertex-format.js').VertexFormat, numVertices: number, options?: {
        usage?: number;
        data?: ArrayBuffer;
        storage?: boolean;
    }, ...args: any[]);
    ...
    format: import("./vertex-format.js").VertexFormat;
    numVertices: number;
    id: number;
    impl: any;
    numBytes: number;
     ...
     * buffer.
     */
    getFormat(): import('./vertex-format.js').VertexFormat;
    /**
