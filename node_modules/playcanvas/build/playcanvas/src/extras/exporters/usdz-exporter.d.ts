...
export class UsdzExporter extends CoreExporter {
     ...
     * @ignore
     */
    meshMap: Map<import('../../scene/mesh.js').Mesh, string>;
    /**
     ...
     * @ignore
     */
    materialMap: Map<import('../../scene/materials/material.js').Material, string>;
    /**
     ...
     * @ignore
     */
    textureMap: Map<import('../../platform/graphics/texture.js').Texture, string>;
    /**
     ...
     */
    build(entity: import('../../framework/entity.js').Entity, options?: {
