...
export class LayerComposition extends EventHandler {
     ...
     */
    layerList: import('../layer.js').Layer[];
    /**
     ...
     * @ignore
     */
    layerIdMap: Map<number, import('../layer.js').Layer>;
    /**
     ...
     * @ignore
     */
    layerNameMap: Map<string, import('../layer.js').Layer>;
    /**
     ...
     * @ignore
     */
    layerOpaqueIndexMap: Map<import('../layer.js').Layer, number>;
    /**
     ...
     * @ignore
     */
    layerTransparentIndexMap: Map<import('../layer.js').Layer, number>;
    /**
     ...
     * @ignore
     */
    camerasMap: Map<import('../../framework/components/camera/component.js').CameraComponent, number>;
    /**
     ...
     */
    push(layer: import('../layer.js').Layer): void;
    /**
     ...
     */
    insert(layer: import('../layer.js').Layer, index: number): void;
    /**
     ...
     */
    remove(layer: import('../layer.js').Layer): void;
    /**
     ...
     * @param {import('../layer.js').Layer} layer - A {@link Layer} to add.
     */
    pushOpaque(layer: import('../layer.js').Layer): void;
    /**
     ...
     * @param {number} index - Insertion position.
     */
    insertOpaque(layer: import('../layer.js').Layer, index: number): void;
    /**
     ...
     * @param {number} index - Insertion position.
     */
    insertTransparent(layer: import('../layer.js').Layer, index: number): void;
    /**
     * Removes a transparent part of the layer from {@link LayerComposition#layerList}.
     *
     * @param {import('../layer.js').Layer} layer - A {@link Layer} to remove.
     */
    removeTransparent(layer: import('../layer.js').Layer): void;
    /**
     ...
     */
    getOpaqueIndex(layer: import('../layer.js').Layer): number;
    /**
     ...
     */
    getTransparentIndex(layer: import('../layer.js').Layer): number;
     ...
     */
    getLayerById(id: number): import('../layer.js').Layer | null;
    /**
     ...
     * Returns null if layer is not found.
     */
    getLayerByName(name: string): import('../layer.js').Layer | null;
