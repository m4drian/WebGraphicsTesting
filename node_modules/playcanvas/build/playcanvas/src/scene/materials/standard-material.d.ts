 ...
 */
export type UpdateShaderCallback = (options: import('./standard-material-options.js').StandardMaterialOptions) => import('./standard-material-options.js').StandardMaterialOptions;
/**
