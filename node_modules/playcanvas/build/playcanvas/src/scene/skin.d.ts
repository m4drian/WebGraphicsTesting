...
export class Skin {
     ...
     */
    constructor(graphicsDevice: import('../platform/graphics/graphics-device.js').GraphicsDevice, ibp: import('../core/math/mat4.js').Mat4[], boneNames: string[]);
    device: import("../platform/graphics/graphics-device.js").GraphicsDevice;
    inverseBindPose: import("../core/math/mat4.js").Mat4[];
    boneNames: string[];
}
