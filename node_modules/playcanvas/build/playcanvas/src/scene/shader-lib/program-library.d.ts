...
export class ProgramLibrary {
     ...
     */
    _generators: Map<string, import('./programs/shader-generator.js').ShaderGenerator>;
    _device: any;
     ...
     */
    generateShaderDefinition(generator: import('./programs/shader-generator.js').ShaderGenerator, name: string, key: number, options: object): object;
