 ...
 * @category Graphics
 */
export function createShader(device: import('../../platform/graphics/graphics-device.js').GraphicsDevice, vsName: string, fsName: string, useTransformFeedback?: boolean | Record<string, boolean | string | string[]>, shaderDefinitionOptions?: {
 ...
 * @category Graphics
 */
export function createShaderFromCode(device: import('../../platform/graphics/graphics-device.js').GraphicsDevice, vsCode: string, fsCode: string, uniqueName: string, attributes?: {
    [x: string]: string;
 ...
 * @ignore
 */
export function processShader(shader: Shader, processingOptions: import('../../platform/graphics/shader-processor-options.js').ShaderProcessorOptions): Shader;
