...
export class BatchManager {
     ...
     */
    constructor(device: import('../../platform/graphics/graphics-device.js').GraphicsDevice, root: import('../../framework/entity.js').Entity, scene: import('../scene.js').Scene);
    device: import("../../platform/graphics/graphics-device.js").GraphicsDevice;
    rootNode: import("../../framework/entity.js").Entity;
