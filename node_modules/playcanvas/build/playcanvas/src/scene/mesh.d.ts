...
export class Mesh extends RefCountedObject {
     ...
     */
    static fromGeometry(graphicsDevice: import('../platform/graphics/graphics-device.js').GraphicsDevice, geometry: import('./geometry/geometry.js').Geometry, options?: {
     ...
     * a storage buffer by a compute shader. Defaults to false. Only supported on WebGPU.
     */
    constructor(graphicsDevice: import('../platform/graphics/graphics-device.js').GraphicsDevice, options?: {
        storageVertex?: boolean;
        storageIndex?: boolean;
    });
    /**
