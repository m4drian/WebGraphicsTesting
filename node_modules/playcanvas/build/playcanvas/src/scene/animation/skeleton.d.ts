...
export class Skeleton {
     ...
     * skeleton.
     */
    constructor(graph: import('../graph-node.js').GraphNode);
    /**
    ...
    _currKeyIndices: {};
    graph: import("../graph-node.js").GraphNode;
    /**
     * Animation currently assigned to skeleton.
     *
     * @type {import('./animation.js').Animation}
     */
    set animation(value: import("./animation.js").Animation);
    get animation(): import("./animation.js").Animation;
    /**
     ...
     */
    setGraph(graph: import('../graph-node.js').GraphNode): void;
    /**
