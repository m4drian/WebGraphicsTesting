...
export class Camera {
     ...
     */
    shaderPassInfo: import('./shader-pass.js').ShaderPassInfo | null;
    /**
     ...
     */
    renderPassDepthGrab: import('../platform/graphics/render-pass.js').RenderPass | null;
    /**
     ...
     */
    renderPasses: import('../platform/graphics/render-pass.js').RenderPass[];
    /** @type {number} */
    jitter: number;
    _aspectRatio: number;
