...
export class Asset extends EventHandler {
     ...
     * @ignore
     */
    static fetchArrayBuffer(loadUrl: string, callback: import('../handlers/loader.js').ResourceLoaderCallback, asset?: Asset, maxRetries?: number): void;
    /**
     ...
     */
    registry: import('./asset-registry.js').AssetRegistry | null;
    /**
