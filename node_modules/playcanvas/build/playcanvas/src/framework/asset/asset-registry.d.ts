 ...
 */
export type BundlesFilterCallback = (bundles: import('../bundle/bundle.js').Bundle[]) => any;
/**
...
export class AssetRegistry extends EventHandler {
     ...
     */
    constructor(loader: import('../handlers/loader.js').ResourceLoader);
    /**
     * @type {Set<Asset>}
     * @private
     */
     ...
     */
    bundles: import('../bundle/bundle-registry.js').BundleRegistry | null;
    _loader: import("../handlers/loader.js").ResourceLoader;
    /**
