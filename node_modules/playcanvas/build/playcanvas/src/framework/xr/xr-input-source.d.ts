...
export class XrInputSource extends EventHandler {
     ...
     * @ignore
     */
    constructor(manager: import('./xr-manager.js').XrManager, xrInputSource: any);
    /**
     * @type {number}
     * @private
     */
     ...
     * @type {import('../entity.js').Entity|null}
     */
    get elementEntity(): import("../entity.js").Entity;
    /**
     * List of active {@link XrHitTestSource} instances associated with this input source.
     *
     * @type {import('./xr-hit-test-source.js').XrHitTestSource[]}
     */
    get hitTestSources(): import("./xr-hit-test-source.js").XrHitTestSource[];
    /**
    ...
    hitTestStart(options?: {
        entityTypes?: string[];
        offsetRay?: Ray;
        callback?: import('./xr-hit-test.js').XrHitTestStartCallback;
    }): void;
    /**
