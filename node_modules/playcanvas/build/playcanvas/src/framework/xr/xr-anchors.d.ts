...
export class XrAnchors extends EventHandler {
     ...
     * @ignore
     */
    constructor(manager: import('./xr-manager.js').XrManager);
    /**
     * @type {import('./xr-manager.js').XrManager}
     * @ignore
     */
    manager: import('./xr-manager.js').XrManager;
    /**
     * @type {boolean}
     * @private
     */
     ...
     * });
     */
    create(position: import('../../core/math/vec3.js').Vec3 | XRHitTestResult, rotation?: import('../../core/math/quat.js').Quat | XrAnchorCreateCallback, callback?: XrAnchorCreateCallback): void;
    /**
     ...
     * }
     */
    forget(uuid: string, callback?: import('./xr-anchor.js').XrAnchorForgetCallback): void;
    /**
