...
export class ContainerResource {
     ...
     * });
     */
    instantiateModelEntity(options?: object): import('../entity.js').Entity;
    /**
     ...
     * });
     */
    instantiateRenderEntity(options?: object): import('../entity.js').Entity;
    /**
     ...
     */
    applyMaterialVariant(entity: import('../entity.js').Entity, name?: string): void;
    /**
     ...
     *     }
     */
    applyMaterialVariantInstances(instances: import('../../scene/mesh-instance').MeshInstance[], name?: string): void;
}
/**
