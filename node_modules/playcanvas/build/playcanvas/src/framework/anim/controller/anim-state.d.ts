...
export class AnimState {
     ...
     */
    constructor(controller: import('./anim-controller.js').AnimController, name: string, speed?: number, loop?: boolean, blendTree?: object | null);
    /** @private */
    private _animations;
    /** @private */
    private _animationList;
    _controller: import("./anim-controller.js").AnimController;
    _name: string;
    _speed: number;
    _loop: boolean;
