...
export class AnimBlendTree extends AnimNode {
     ...
     */
    constructor(state: import('./anim-state.js').AnimState, parent: AnimBlendTree | null, name: string, point: number | import('../../../core/math/vec2.js').Vec2, parameters: string[], children: object[], syncAnimations: boolean, createTree: Function, findParameter: Function);
    _parameters: string[];
