...
export class AnimNode {
     ...
     */
    constructor(state: import('./anim-state.js').AnimState, parent: import('./anim-blend-tree.js').AnimBlendTree | null, name: string, point: number[] | number, speed?: number);
    _state: import("./anim-state.js").AnimState;
    _parent: import("./anim-blend-tree.js").AnimBlendTree;
    _name: string;
    _point: number | Vec2;
    _pointLength: number;
    _speed: number;
    ...
    _weight: number;
    _animTrack: any;
    get parent(): import("./anim-blend-tree.js").AnimBlendTree;
    get name(): string;
    get path(): any;
