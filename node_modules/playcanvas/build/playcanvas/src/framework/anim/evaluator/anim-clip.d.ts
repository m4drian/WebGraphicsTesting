...
export class AnimClip {
     ...
     */
    constructor(track: import('./anim-track.js').AnimTrack, time: number, speed: number, playing: boolean, loop: boolean, eventHandler?: import('../../../core/event-handler.js').EventHandler);
    _name: string;
    _track: import("./anim-track.js").AnimTrack;
    ...
    get name(): string;
    set track(track: import("./anim-track.js").AnimTrack);
    get track(): import("./anim-track.js").AnimTrack;
