...
export class AppBase extends EventHandler {
     ...
     */
    init(appOptions: import('./app-options.js').AppOptions): void;
    /**
     ...
     */
    lightmapper: import('./lightmapper/lightmapper.js').Lightmapper;
    /**
     ...
     * }
     */
    xr: import('./xr/xr-manager.js').XrManager;
    /**
     * @type {boolean}
     * @ignore
     */
    ...
    _hiddenAttr: string;
    tick: (timestamp?: number, frame?: any) => void;
    /** @private */
     ...
     * @ignore
     */
    get soundManager(): import("../platform/sound/manager.js").SoundManager;
    /**
     ...
     * @type {import('../scene/batching/batch-manager.js').BatchManager}
     */
    get batcher(): import("../scene/batching/batch-manager.js").BatchManager;
    /**
     ...
     */
    configure(url: string, callback: (err: string | null) => void): void;
    /**
     ...
     * @ignore
     */
    drawMeshInstance(meshInstance: import('../scene/mesh-instance.js').MeshInstance, layer?: Layer): void;
    /**
     ...
     * @ignore
     */
    drawMesh(mesh: import('../scene/mesh.js').Mesh, material: Material, matrix: Mat4, layer?: Layer): void;
    /**
     ...
     * @ignore
     */
    drawTexture(x: number, y: number, width: number, height: number, texture: import('../platform/graphics/texture.js').Texture, material: Material, layer?: Layer, filterable?: boolean): void;
    /**
