...
export class ContactResult {
     ...
     * @ignore
     */
    constructor(other: import('../../entity.js').Entity, contacts: ContactPoint[]);
    /**
     * The entity that was involved in the contact with this entity.
     *
     * @type {import('../../entity.js').Entity}
     */
    other: import('../../entity.js').Entity;
    /**
...
export class RaycastResult {
     ...
     * @ignore
     */
    constructor(entity: import('../../entity.js').Entity, point: Vec3, normal: Vec3, hitFraction: number);
    /**
...
export class SingleContactResult {
     ...
     * @ignore
     */
    constructor(a: import('../../entity.js').Entity, b: import('../../entity.js').Entity, contactPoint: ContactPoint, ...args: any[]);
    /**
     * The first entity involved in the contact.
     *
     * @type {import('../../entity.js').Entity}
     */
    a: import('../../entity.js').Entity;
    /**
     * The second entity involved in the contact.
     *
     * @type {import('../../entity.js').Entity}
     */
    b: import('../../entity.js').Entity;
    /**
