...
export class AnimComponentLayer {
     ...
     * @ignore
     */
    constructor(name: string, controller: import('../../anim/controller/anim-controller.js').AnimController, component: import('./component.js').AnimComponent, weight?: number, blendType?: string);
    /**
     * @type {string}
     * @private
     */
     ...
     */
    getAnimationAsset(stateName: string): import('../../asset/asset.js').Asset;
    /**
