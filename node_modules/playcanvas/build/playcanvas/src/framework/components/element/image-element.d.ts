export class ImageElement {
    ...
    _texture: import('../../../platform/graphics/texture.js').Texture;
    /** @type {number} */
    _materialAsset: number;
    /** @type {import('../../../scene/materials/material.js').Material} */
    _material: import('../../../scene/materials/material.js').Material;
    /** @type {number} */
    _spriteAsset: number;
    /** @type {import('../../../scene/sprite.js').Sprite} */
    _sprite: import('../../../scene/sprite.js').Sprite;
    _spriteFrame: number;
    /** @type {number} */
    ...
    set texture(value: import("../../../platform/graphics/texture.js").Texture);
    ...
    set sprite(value: import("../../../scene/sprite.js").Sprite);
