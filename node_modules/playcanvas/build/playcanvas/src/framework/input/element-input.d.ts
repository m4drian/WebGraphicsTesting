...
export class ElementInput {
     ...
     * ElementComponent.
     */
    addElement(element: import('../components/element/component.js').ElementComponent): void;
    /**
     ...
     * ElementComponent.
     */
    removeElement(element: import('../components/element/component.js').ElementComponent): void;
...
export class ElementInputEvent {
     ...
     */
    constructor(event: import('../../platform/input/mouse-event.js').MouseEvent | import('../../platform/input/touch-event.js').TouchEvent, element: import('../components/element/component.js').ElementComponent, camera: import('../components/camera/component.js').CameraComponent);
    /**
     ...
     */
    event: import('../../platform/input/mouse-event.js').MouseEvent | import('../../platform/input/touch-event.js').TouchEvent;
    /**
     * The ElementComponent that this event was originally raised on.
     *
     * @type {import('../components/element/component.js').ElementComponent}
     */
    element: import('../components/element/component.js').ElementComponent;
    /**
     * The CameraComponent that this event was originally raised via.
     *
     * @type {import('../components/camera/component.js').CameraComponent}
     */
    camera: import('../components/camera/component.js').CameraComponent;
...
export class ElementMouseEvent extends ElementInputEvent {
     ...
     */
    constructor(event: import('../../platform/input/mouse-event.js').MouseEvent, element: import('../components/element/component.js').ElementComponent, camera: import('../components/camera/component.js').CameraComponent, x: number, y: number, lastX: number, lastY: number);
    x: number;
    y: number;
    /**
...
export class ElementSelectEvent extends ElementInputEvent {
     ...
     */
    constructor(event: object, element: import('../components/element/component.js').ElementComponent, camera: import('../components/camera/component.js').CameraComponent, inputSource: import('../xr/xr-input-source.js').XrInputSource);
    /**
     * The XR input source that this event was originally raised from.
     *
     * @type {import('../xr/xr-input-source.js').XrInputSource}
     */
    inputSource: import('../xr/xr-input-source.js').XrInputSource;
}
/**
...
export class ElementTouchEvent extends ElementInputEvent {
     ...
     */
    constructor(event: import('../../platform/input/touch-event.js').TouchEvent, element: import('../components/element/component.js').ElementComponent, camera: import('../components/camera/component.js').CameraComponent, x: number, y: number, touch: import('../../platform/input/touch-event.js').Touch);
    /**
     ...
     */
    touches: import('../../platform/input/touch-event.js').Touch[];
    /**
     ...
     * @type {import('../../platform/input/touch-event.js').Touch[]}
     */
    changedTouches: import('../../platform/input/touch-event.js').Touch[];
    x: number;
    y: number;
    /**
     ...
     * @type {import('../../platform/input/touch-event.js').Touch}
     */
    touch: import('../../platform/input/touch-event.js').Touch;
}
