...
class GSplatData {
  ...
  constructor(elements, options = {}) {
    ...
    if (!this.isCompressed) {
      var _options$performZScal, _options$reorder;
      if ((_options$performZScal = options.performZScale) != null ? _options$performZScal : true) {
        mat4.setScale(-1, -1, 1);
        this.transform(mat4);
      }
      ...
      if ((_options$reorder = options.reorder) != null ? _options$reorder : true) {
        this.reorderData();
      }
    }
  }
